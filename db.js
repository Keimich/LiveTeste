...
query.s = (el) => {
    tp.sql("select soma from tbs_cod_nome where cod = @cod_nome; select soma from tbs_cod_sobrenome where cod = @cod_sobrenome; select soma from tbs_cod_email where cod = @cod_email;")
        .parameter('cod_nome', TYPES.BigInt, el.cod_nome)
        .parameter('cod_sobrenome', TYPES.BigInt, el.cod_sobrenome)
        .parameter('cod_email', TYPES.BigInt, el.cod_email)
        .execute()
